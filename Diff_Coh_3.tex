...
\end{corollary}
Note, the general condition above is equivalent to the following simpler condition. Denote by $0_n$ the origin of $\bR^n$.\nrnote{It seems to me the next result requires knowing about the Euclidean site, which comes later, or is there an easy way to see this?} 
\begin{corollary}
