...
\begin{remark}
  Let $\Euc$ be the full, dense sub-site of $\Mfd$ generated by Euclidean manifolds $\bR^n$, for every $n\geq0$. Recall that, for every presentable category $\C$, the restriction functor induces an equivalence $\Shv(\Mfd,\C)\simeq\Shv(\Euc,\C)$, see \cite[Corollary A.5.6]{amabeldebrayhaine2021diffcoh}.
\end{remark}
